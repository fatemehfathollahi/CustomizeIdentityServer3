...
$.fn.dataTableExt.oPagination.input = {
	"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
	{
		...
		nFirst.className = "btn btn-sm btn-default first disabled";
		nPrevious.className = "btn btn-sm btn-default previous disabled";
		nNext.className="btn btn-sm btn-default next";
		nLast.className = "btn btn-sm btn-default last";
		nOf.className = "paginate_of";
		nPage.className = "paginate_page";
		nInput.className = "form-control input-sm input-inline w-40 paginate_input ml-5 mr-5";
