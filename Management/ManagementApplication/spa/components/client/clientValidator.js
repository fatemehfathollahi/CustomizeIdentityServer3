    					...
    					validators: {
    						notEmpty: {
                                ...
                                callback: function (value, validator, $field) {
                                    ...
                                    meParams.ClientId = value;
                                    meParams.async = false;
                                    commonMethod.ExistsClientId(function (output, error) {
                                        if (output) {
                                            outputValue = false;
                                            outputMessage = 'ClientId is duplicate';
                                        }
                                        return {
                                            valid: outputValue,
    					...
    					validators: {
    						notEmpty: {
    							...
    							callback: function (value, validator, $field) {
    								...
    								var meParams = {};
    								meParams.Id = params.model.Id();
    								meParams.ClientName = value;
    								meParams.async = false;
    								commonMethod.ExistsClientName(function (output, error) {
    									if (output) {
    										outputValue = false;
    										outputMessage = 'ClientName is duplicate';
    									}
    									return {
    										valid: outputValue,
    										message: outputMessage
