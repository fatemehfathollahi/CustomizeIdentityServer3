...
{
	public class ManagerDBContext : DataContext
	{
		...
		public ManagerDBContext() : base("Name=SecurityDBContext")
		{
			this.Configuration.LazyLoadingEnabled = true;
		}

		public ManagerDBContext(DbConnection dbConnection) : base(dbConnection, false)
		{
			this.Configuration.LazyLoadingEnabled = true;
		}
