...
{
	internal class ClientListDTOProfile : Profile
	{
		public ClientListDTOProfile()
		{
			CreateMap<Client, ClientListDTO>()
				...
				.ForMember(desc => desc.LogoUri, opts => opts.MapFrom(src => Convert.FromBase64String(src.LogoUri)))
